...
According to contrast result of GLM on Bali dataset, Lowest estimated value is found at Nuclear Plant Issue which is followed by Algal Reef Issue (Figure.2, Table.4). No significant relationships are detected in every issue-pair containing Algal Reef Issue. GLM of Bali also fails to significantly explain the dataset (p-value of Chi-square score=0.999909, df=9).
